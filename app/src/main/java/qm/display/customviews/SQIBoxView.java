...
/* Start main class */
public class SQIBoxView extends View {
	...
	/** ---- Class constructors ---- **/
	public SQIBoxView(Context context) {
		super(context);
	...
	public SQIBoxView(Context context, AttributeSet attrs) {
		super(context, attrs);
        ...
        //
        // This call uses R.styleable.SQIBoxView, which is an array of
        // the custom attributes that were declared in values/attrs.xml.
		TypedArray attributes = context.getTheme().obtainStyledAttributes(
				attrs, R.styleable.SQIBoxView, 0, 0);
		
		try {
			// Retrieve the values from the TypedArray and store into
	        // fields of this class.
			lb_Background_Size = attributes.getInteger(R.styleable.SQIBoxView_SQI_label_Background_Size, 25);
			lb_Background_Color = attributes.getColor(R.styleable.SQIBoxView_SQI_label_Background_Color, Color.WHITE);
			lb_text = attributes.getString(R.styleable.SQIBoxView_SQI_label_Text);
			lb_Text_Color = attributes.getColor(R.styleable.SQIBoxView_SQI_label_Text_Color, Color.BLACK);
			lb_Text_BelowBaseLine = attributes.getBoolean(R.styleable.SQIBoxView_SQI_label_Text_BelowBaseLine, false);
			vl_text = attributes.getString(R.styleable.SQIBoxView_SQI_value_Text);
			vl_Text_Color = attributes.getColor(R.styleable.SQIBoxView_SQI_value_Text_Color, Color.WHITE);
			vl_Text_BelowBaseLine = attributes.getBoolean(R.styleable.SQIBoxView_SQI_value_Text_BelowBaseLine, false);
		} finally {
	...
	/* --- Set value text and repaint view --- */
